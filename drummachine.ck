...
[2,0,2,0,1,2,0,0,1  ] @=> int kickP[];

[0,1,0,1,0,0,2,0,1
   ] @=> int snareP[];

[1,0,1,1,0,1,1,0,1,1,0,1  ] @=> int hihatP[];


.130*1.2::second => dur oneShuffle; // every first 16th, longer
.120*1.2::second => dur twoShuffle; // every second 16th, shorter
